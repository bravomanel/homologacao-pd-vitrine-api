// const token = 'window.env.GITLAB_TOKEN';
...
//     divMae.innerHTML += `
//     <article class="col card-index d-flex flex-column justify-content-center align-items-center m-0 p-0 position-relative">
...
//             <img src="./../imagens/icones/Responsável Tecnico.svg" alt="responsável técnico" class="card-index__icones">
//             <div>
...
// // adicionarCard("matheus.lopes")

// colaboradores.forEach(colaborador => {
//     adicionarCard(colaborador);
// });
